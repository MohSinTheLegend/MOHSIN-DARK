...
\033[1;97m----------------------------------------------------------------------------
\033[1;97m----------------------------------------------------------------------------
 \033[1;91m Coded by : @_MOHSIN ALI 
 \033[1;92m GitHub   : \033[1;93m@MohsinTheLegend
 \033[1;94m WHATSAPP : 03063112***
 \033[1;93m PAGE     : MOHSIN TRICKER 
 \033[1;97m FACEBOOK : MOHSIN ALI 
 \033[1;94m NOTE     : DON'T TRY TO COPY
\033[1;97m----------------------------------------------------------------------------
"""
...
def login_choice():
    ...
    os.system('clear')
    print logo
    print ("[1] \033[1;92mCLONE FRIEND LIST and Public ID ")
       print ("[0] Exit")
    print u"\u001b[1;46m---------------------------------------------"
    loginvia()
def clone_main():
...
def loginvia():
    ...
    os.system('clear')
    print logo
    print ("[1] \033[1;91mLogin With Token \033[1;90m(\033[1;93mNoCp\033[1;90m)\033[1;97m ")
...
def clone_loginvia():
    ...
    if hack =="1":
        ...
        os.system('clear')
        print logo
        print ("MOHSIN THE BRAND").center(70)
        print u"\u001b[1;46m---------------------------------------------"
        ...
        time.sleep(0.5)
        os.system("clear")
        print("Token is Saved").center(70)
        time.sleep(4)
...
def loginfb():
    ...
    if "access_token" in q:
        ...
        if "www.facebook.com" in q["error_msg"]:
            ...
            print("\n\033[1;31m[!] Login NEW Email/ID/Number OR Password")
            time.sleep(0.5)
            loginfb()
...
def crack():
        ...
        os.system('clear')
        print logo
        print ("[1] CRACK FROME FRIENDS")
        print ("[2] CRACK FROM \033[1;92mID\033[1;97m Public ID")
        print ('[0] Back')
        print u"\u001b[1;46m---------------------------------------------"
        crack2()
def crack2():
        ...
        down()
def down():
    dow = raw_input("[?] SAVE FILE IN YOUR PHONE BY SYCO ? (Y/N) ")
    if dow =="yes" or dow =="y":
        os.system("clear")
        print logo
        download()
